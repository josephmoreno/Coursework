...
set_property PACKAGE_PIN H22 [get_ports left];

set_property IOSTANDARD LVCMOS33 [get_ports din];
set_property PACKAGE_PIN F21 [get_ports {din[3]}];
set_property PACKAGE_PIN H19 [get_ports {din[2]}];
set_property PACKAGE_PIN H18 [get_ports {din[1]}];
set_property PACKAGE_PIN H17 [get_ports {din[0]}];
