...
HD_PWD='C:/Users/Joseph/Desktop/Current HW/FPGA HW/Vivado Projects/A4_problem1/A4_problem1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shiftreg_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shiftreg_4bit.tcl
