...
HD_PWD='C:/Users/Joseph/Desktop/Current HW/FPGA HW/Vivado Projects/A4_problem1/A4_problem1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shiftreg_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shiftreg_4bit.tcl -notrace
