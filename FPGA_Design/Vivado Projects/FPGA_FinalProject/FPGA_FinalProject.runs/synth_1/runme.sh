...
HD_PWD='C:/Users/Joseph/Desktop/Current HW/FPGA HW/Vivado Projects/FPGA_FinalProject/FPGA_FinalProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pattern_recognizer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pattern_recognizer.tcl
