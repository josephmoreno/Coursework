...
HD_PWD='C:/Users/Joseph/Desktop/Current HW/FPGA HW/Vivado Projects/FPGA_FinalProject/FPGA_FinalProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pattern_recognizer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pattern_recognizer.tcl -notrace
