...
HD_PWD='C:/Users/Joseph/Desktop/Current HW/FPGA HW/Vivado Projects/A5_problem2/A5_problem2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log slave.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source slave.tcl
