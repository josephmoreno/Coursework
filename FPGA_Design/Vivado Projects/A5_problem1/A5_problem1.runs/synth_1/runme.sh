...
HD_PWD='C:/Users/Joseph/Desktop/Current HW/FPGA HW/Vivado Projects/A5_problem1/A5_problem1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bitPattern_FSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bitPattern_FSM.tcl
