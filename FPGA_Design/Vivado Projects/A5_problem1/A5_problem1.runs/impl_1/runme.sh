...
HD_PWD='C:/Users/Joseph/Desktop/Current HW/FPGA HW/Vivado Projects/A5_problem1/A5_problem1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bitPattern_FSM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bitPattern_FSM.tcl -notrace
