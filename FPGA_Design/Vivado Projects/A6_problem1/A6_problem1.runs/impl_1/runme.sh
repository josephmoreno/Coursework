...
HD_PWD='C:/Users/Joseph/Desktop/Current HW/FPGA HW/Vivado Projects/A6_problem1/A6_problem1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sorter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sorter.tcl -notrace
